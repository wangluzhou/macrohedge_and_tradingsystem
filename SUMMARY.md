...
* [大类资产配置模型](asset-allocation-model/README.md)
  ...
  * [单因子校验系统](asset-allocation-model/single-factor-validation.md)
    * [PMI因子](asset-allocation-model/pmi.md)
  ...
  * [因子加权风险平价模型](asset-allocation-model/factor-weighted-risk-parity.md)
* [交易系统](trading_system/README.md)
* [附录1:万得EDB代码](appendix/appendix1.md)
* [附录2:MongoDB使用](appendix/appendix2.md)
* [附录3:因子事件参数配置格式](appendix/config-json.md)
* [参考资料](reference/README.md)
* [TODO LIST](reference/to-do-list.md)
